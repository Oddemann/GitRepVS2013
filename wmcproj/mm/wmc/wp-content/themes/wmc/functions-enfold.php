...
if(!function_exists('avia_title'))
{
	function avia_title($args = false, $id = false)
	{
		...
		$defaults 	 = array(
			...
			'html'			=> "<div class='{class} title_container'><div class='container'><div class='slogan'>For safer medical treatment. World Medical Card &reg;</div><{heading} class='main-title entry-title'>{title}</{heading}>{additions}</div></div>",
