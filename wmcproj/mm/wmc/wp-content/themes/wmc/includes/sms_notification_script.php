...
// for calling Kapow sms function
...
switch($eventType)
{
	case $PAYMENT_RECEIVED:
		$mm_ods_melding="WMC har mottatt betaling";
		break;
		
	case $PAYMENT_REBILL:
		$mm_ods_melding= "WMC har mottatt periodisk betaling";
		break;
		
	case $REFUND_ISSUED:
		$mm_ods_melding="WMC har betalt tilbake en pengesum";
		break;
}

if ($mm_ods_melding != '')
    $fraSendMess= send_message('truls','wmctf35',$phone,$mm_ods_melding,'','','','','','');
$mm_ods_melding = '';
?>